...
public class UIUtilities {
  ...
  public static func imageOrientation(
    ...
    public static func isLandmarkRight(type: String) -> Bool {
        return type.hasPrefix("Right")
    }
  ...
  public static func createPoseOverlayView(
    ...
    for landmark in pose.landmarks {
      ...
      UIUtilities.addCircle(
        ...
        to: overlayView,
        color: isLandmarkRight(type: landmark.type.rawValue) ? UIColor.orange : UIColor.cyan,
        radius: dotRadius
      )
    }
    return overlayView
